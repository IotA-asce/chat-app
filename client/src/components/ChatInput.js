...
const ChatInput = ({
  ...
  setMessageList
    ...
    <div className="chatInput">
      <div className="chatInputInserts">
        {isEmojiSelected && <CrossButton setIsEmojiSelected={setIsEmojiSelected}/>}
        {!isEmojiSelected && <EmojiButton setIsEmojiSelected={setIsEmojiSelected} />}
        <AttachmentButton />
      </div>
      <div className="chatInputInputBar">
        <input
          type="text"
          ...
          className="chatInputInputField"
        />
      </div>
      <div className="chatInputMicWrapper">
        <MicButton />
      </div>
      {/*
            <ButtonTwo />
...
const CrossButton = ({setIsEmojiSelected}) => {
  return (
    <svg viewBox="0 0 24 24" width="24" height="24" className="" onClick={() => {setIsEmojiSelected(false)}}>
      <path
        fill="currentColor"
...
const EmojiButton = ({setIsEmojiSelected}) => {
  return (
    <svg viewBox="0 0 24 24" width="24" height="24" className="ekdr8vow dhq51u3o" onClick={() => {setIsEmojiSelected(true)}}>
      <path
        fill="currentColor"
