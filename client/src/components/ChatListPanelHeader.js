...
const ChatListPanelHeader = ({socket, username}) => {

  return (
    <div className="panelHeader">
      <div className="panelHeaderIcon">
        {/* {socket.id} */}
      </div>
      <div className="socketID">
        {username}
      </div>
      <div className="panelHeaderOptions">
        <Status />
        <NewChat />
        <Options />
      </div>
